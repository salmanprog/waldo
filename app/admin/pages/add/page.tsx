  ...
  return (
    <div className="p-4 mx-auto md:p-6">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-white/90">Add Page</h2>
        <nav>
          <ol className="flex items-center gap-1.5">
            ...
            <li className="text-sm text-gray-800 dark:text-white/90">Add Page</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
          <h2 className="text-lg font-medium text-gray-800 dark:text-white">Page Details</h2>
        </div>
          ...
          <form onSubmit={submitPage} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs bg-transparent border-gray-300 focus:border-brand-300 dark:bg-gray-900 dark:text-white dark:border-gray-700"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="h-11 w-full rounded-lg border px-4 py-2.5 shadow-theme-xs bg-transparent border-gray-300 dark:bg-gray-900 dark:text-white"
              >
