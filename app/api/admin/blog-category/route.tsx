...
export async function POST(request: Request) {
  ...
  try {
    if (contentType.includes("multipart/form-data")) {
      ...
      const folderName = "blog-category";
    ...
    console.error("Error uploading blog category image:", error);
    return NextResponse.json(
...
export async function GET(req: Request) {
  ...
  const controller = new AdminBlogCategoryController(req, { id: Number(user.id) });
