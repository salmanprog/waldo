...
import AdminController, { ExtendedUser } from "@/controllers/AdminController";
...
export async function GET(
  ...
  try {
    const controller = new AdminController(_req);
...
export async function PATCH(
  ...
  try {
    ...
    const controller = new AdminController(request, data);
