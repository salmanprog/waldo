...
import AdminEventController, { ExtendedEvent } from "@/controllers/AdminEventController";
...
export async function POST(request: Request) {
  ...
  let data: Partial<ExtendedEvent> = {};
  ...
  try {
    ...
    const controller = new AdminEventController(request, data);
...
export async function GET(req: Request) {
  ...
  const controller = new AdminEventController(req, { id: Number(user.id) });
